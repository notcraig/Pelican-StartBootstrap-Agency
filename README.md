...
The `contents` folder contains portfolio, team, about and 'client logos' images (*see [sample_content](/Pelican-StartBootstrap-Agency/tree/master/sample_content) folder*).  
